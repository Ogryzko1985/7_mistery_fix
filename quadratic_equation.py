...
parametr_a = int(input("Print parametr_a:"))
parametr_b = int(input("Print parametr_b:"))
parametr_c = int(input("Print parametr_c:"))
...
def get_roots(parametr_a, parametr_b, parametr_c):
    ...
    if __name__ == '__main__':
        solution = get_roots(parametr_a, parametr_b, parametr_c)
